...
public abstract class Iterator implements Flags
{
	 ...
	 * it is set to true the first time the <code>close()</code> function is called.
	 ...
	 *                some join exception
	 * @exception IndexException
	 *                exception from Index class
	 * @exception SortException
	 *                exception Sort class
	 */
	 ...
	 *            the number of pages
	 * @param PageIds
	 *            the corresponding PageId for each page
	 * @param bufs
	 *            the buffer space
	 * @exception IteratorBMException
	 *                exceptions from bufmgr layer
	 */
	public void get_buffer_pages(int n_pages, PageId[] PageIds, byte[][] bufs) throws IteratorBMException
	{
