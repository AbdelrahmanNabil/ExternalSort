...
class BTDriver implements GlobalConst
{
	...
	protected void runAllTests()
	{
		...
		while (choice != 19)
		{
			...
			try
			{
				System.out.println("pgs pinned " + (SystemDefs.JavabaseBM.getNumBuffers() - SystemDefs.JavabaseBM.getNumUnpinnedBuffers()));
				...
				switch (choice)
				{
					...
					case 6:
						...
						pageno.pid = key;
						rid = new RID(pageno, key);
						System.out.println(file.Delete(new IntegerKey(key), rid));
						break;
					case 7:
						file.close();
						postfix++;
					...
					case 12:
						...
						/*
						 * KeyDataEntry e = scan.get_next();
						 * 
						 * while(e != null)
						 * {
						 * System.out.println(e.key + "  " + ((LeafData)e.data).getData().slotNo);
						 * e = scan.get_next();
						 * }
						 */
						break;
